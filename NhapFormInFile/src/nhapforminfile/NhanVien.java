...
public class NhanVien extends Person{
    ...
    public NhanVien(String phongBan, double heSoLuong, double thamNien, double luongCoBan, String hoTen, String ngaySinh, String diaChi, boolean gioiTinh) {
    ...
    {
        return this.luongCoBan*heSoLuong*(1+thamNien/100);
    }

    @Override
    public String toString() {
        return super.toString() + "$" + phongBan + "$" + heSoLuong 
                + "$" + thamNien + "$" + luongCoBan + "$" + getLuongThucLinh();
    }

...
public class FormDangNhap extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        if (isAnyEmptyField())
        {
            JOptionPane.showMessageDialog(null, "Dien day du Username Password");
            return;
        }
        ...
        if (isExistAccount(u))
        {
            ImageIcon icon = new ImageIcon("src/javaswingform/phoenix.jpg");
            System.out.println(icon.getImage());
            lbDisplayUsername.setText("Login successfully");
            JOptionPane.showMessageDialog(null,"","Yo BITCHES",JOptionPane.INFORMATION_MESSAGE,icon);
            pi.setVisible(true);
        }
        else
        {
